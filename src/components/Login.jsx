...
const Login = () => {
    ...
    return (
        <div className="container mx-auto flex justify-center items-center">
            ...
            <div className="flex justify-center mt-12 rounded items-center border border-gray-400">
            <div className="bg-[#445139]">
                <img className='py-24 mx-auto w-[80%]' src="https://i.ibb.co/zR4ZRYD/image-processing20210613-1005-1g7cwuk-removebg-preview.png" alt="" />
            </div>
