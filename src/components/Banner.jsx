...
const Banner = () => {
    return (
        <div className=" bg-blend-multiply  bg-gray-600  bg-[url('https://rb.gy/4y7zh')] bg-cover">
         ...
         <div className="flex text-white flex-col mb-36 justify-center items-center">
         ...
         <h1 className="text-5xl text-center uppercase font-semibold mt-5">Plan The perfect wedding</h1>
        ...
        <img className=" w-full h-[90px]" src="https://i.ibb.co/hKp9SKq/wave.png" alt="" />
